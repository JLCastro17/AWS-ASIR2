			...
			<div id='contenido'>
				<div id='tabla'>
					<table class='muse muse-border tabla'>
						...
						$result = mysqli_query($connection, "SELECT image FROM personajes WHERE nombre='$nombre'");
					...
					echo "' alt='$nombre' /></td>
						...
						<tr>
							...
							<td>";
						$result = mysqli_query($connection, "SELECT nacimiento FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td><b>Género</b></td>
							<td>";
						$result = mysqli_query($connection, "SELECT genero FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td><b>Estado</b></td>
							<td>";
						$result = mysqli_query($connection, "SELECT estado FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td><b>Estatura</b></td>
							<td>";
						$result = mysqli_query($connection, "SELECT estatura FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td><b>Ocupación</b></td>
							<td>";
						$result = mysqli_query($connection, "SELECT ocupacion FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td class='no-line'><b>Rango</b></td>
							<td class='no-line'>";
						$result = mysqli_query($connection, "SELECT rango FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td class='principal nombre no-line' colspan='2'><b>Actriz de voz</b></td>
						</tr>
						<tr>
							<td class='no-line'><b>Nombre</b></td>
							<td class='no-line'>";
						$result = mysqli_query($connection, "SELECT nombre_seiyuu FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td class='principal nombre no-line' colspan='2'><b>Primera aparición</b></td>
						</tr>
						<tr>
							<td><b>Manga</b></td>
							<td>";
						$result = mysqli_query($connection, "SELECT manga FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
						...
						<tr>
							<td class='no-line'><b>Anime</b></td>
							<td class='no-line'>";
						$result = mysqli_query($connection, "SELECT anime FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "</td>
				...
				<article id='informacion' class='muse muse-border'>
					<h2>$nombre</h2>
					<br />";
						$result = mysqli_query($connection, "SELECT biografia FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "<br/><hr /><br />
					<h3>Personalidad</h3>
					<br />";
						$result = mysqli_query($connection, "SELECT personalidad FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "<br/><hr /><br />
					<h3>Apariencia</h3>
					<br />";
						$result = mysqli_query($connection, "SELECT apariencia FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "<br/><hr /><br />
					<h3>Habilidades</h3>
					<br />";
						$result = mysqli_query($connection, "SELECT habilidades FROM personajes WHERE nombre='$nombre'");
						while($query_data = mysqli_fetch_row($result)) {
							echo $query_data[0];
						}
					echo "<br/><hr /><br />
